...
public class EmailTemplate {
    ...
    public static String createEmailHtml(String asteroidContent, String apodContent, LocalDateTime generatedTime, String userName) {
        ...
        htmlContent.append("Hello ").append(userName != null ? userName : "Space Enthusiast").append("! This week we're tracking several interesting objects making close approaches to Earth. ");
